...
namespace Bumbo.Web.Models.AdditionalWork
{
    public class IndexViewModel
    {
        ...
        [Required]
        public List<AdditionalWork> Schedule { get; set; }

        public class AdditionalWork : IValidatableObject
        {
            [Required]
            ...
            {
                var localizer = (IStringLocalizer)validationContext.GetService(typeof(IStringLocalizer<AdditionalWork>));
