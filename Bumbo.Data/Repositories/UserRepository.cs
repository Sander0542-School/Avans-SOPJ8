    ...
    public class UserRepository : RepositoryBase<User>
    {
        ...
        public async Task<List<User>> GetUsersAndShifts(Branch branch, int year, int week, Department? department)
        {
            ...
            return await Context.Users
                ...
                .Where(user => user.Branches.Any(userBranch => !department.HasValue || userBranch.Department == department.Value))
                ...
                .Include(user => user.Shifts
                    ...
                    .Where(shift => !department.HasValue || shift.Department == department.Value)
